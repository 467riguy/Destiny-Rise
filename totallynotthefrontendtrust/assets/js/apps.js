...
function CreateCustomApp(customApp) {
    ...
    const face = document.createElement("face");
    face.width = 145;
    face.height = 145;
    face.src = customApp.face;
    face.loading = "lazy";
        ...
        for (const app of appsList) {
            ...
            const url = document.createElement("a");
                        ...
                        if (app.error) {
                            ...
                            paragraph.style.color = "yellow";
                            if (!app.say) {
                                app.say = "This app is currently going through some issues, remember, dynamic doesn't work in a:b";
                            }
                        }
